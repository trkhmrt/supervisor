...
export default function SupervisorProfilePage() {
  ...
  return (
    <SiteShell>
          ...
          <div className="grid lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-5">
               <div className="card-premium sticky top-32">
                  ...
                  <Link href="#randevu" className="btn-navy w-full">
                     Hemen Randevu Al
      ...
      <section id="randevu" className="py-24 bg-clinical-light border-y border-clinical-border">
        <div className="container-wide">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <Reveal>
              <span className="info-highlight text-xs uppercase tracking-widest">Kolay Randevu Akisi</span>
            </Reveal>
            <Reveal delay={0.1}>
            ...
            <Reveal delay={0.2}>
              <p className="mt-4 text-clinical-muted">
                {supervisor.fullName} ile seansinizi planlamak icin tarih, saat ve onayi ayni panelde tamamlayin.
              </p>
            </Reveal>
          </div>
