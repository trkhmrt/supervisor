        ...
        <div className="container-wide">
          ...
          <Reveal delay={0.2}>
            <p className="text-navy-200 text-lg max-w-2xl leading-relaxed">
              Hizmetler sunucuda veritabanından yüklenir (SSR).
            </p>
          </Reveal>
        </div>
      </section>
        ...
        <div className="container-wide">
          {fetchError || services.length === 0 ? (
            <DbEmptyNotice
              loading={false}
              error={fetchError}
              emptyLabel="Henüz hizmet yok. Panelim → Hizmetler bölümünden ekleyin."
            />
          ) : (
                ...
                <StaggerItem key={s.id}>
                  <div className="card-premium h-full flex flex-col md:flex-row gap-8 p-10 group">
                    ...
                    <div className="flex-1 flex flex-col">
                      ...
                      <p className="text-clinical-muted text-sm leading-relaxed mb-8">{s.description}</p>
