...
import { ArrowRight, ShieldCheck, MailCheck, AlertCircle, Info } from "lucide-react";
...
export default function RegisterPage() {
  ...
  const registerSupervisee = useAppStore((s) => s.registerSupervisee);
      ...
      <SiteShell>
        <section className="min-h-screen bg-clinical-light flex items-center justify-center pt-20">
          <div className="container-narrow text-center py-24 bg-white rounded-premium shadow-2xl border border-clinical-border px-12">
            ...
            <button
              onClick={() => {
                verifyEmail(createdUserId);
                setStep("done");
              }}
              className="btn-navy py-3 px-8"
            >
              Doğrulamayı Onayla (Demo)
              <ArrowRight className="h-4 w-4" />
            </button>
          </div>
        </section>
          ...
          <div className="w-full max-w-6xl grid lg:grid-cols-12 bg-white rounded-premium shadow-2xl overflow-hidden border border-clinical-border">
            ...
            <div className="lg:col-span-5 bg-navy-900 text-white p-12 md:p-16 flex flex-col relative overflow-hidden">
               ...
               <div className="relative z-10 flex-1">
                  ...
                  <p className="text-navy-300 leading-relaxed mb-12">
                    Süpervizyon Alan olarak ücretsiz hesabınızı oluşturun. 
                    Klinik gelişiminizi profesyonel bir altyapı ile destekleyin.
                  </p>
                  
                  <div className="bg-white/5 backdrop-blur border border-white/10 p-8 rounded-premium">
                     <div className="flex items-start gap-4">
                        <Info className="h-6 w-6 text-navy-400 shrink-0" />
                        <div>
                           <h4 className="font-bold text-white text-sm mb-2">Süpervizör müsünüz?</h4>
                           <p className="text-navy-300 text-xs leading-relaxed mb-4">
                              Süpervizör kayıtları sadece davet usulü ile yapılmaktadır. 
                              Başvuru için bizimle iletişime geçin.
                           </p>
                           <Link href="/iletisim" className="text-xs font-bold text-white hover:text-accent-gold transition-colors">
                              İletişime Geç →
                           </Link>
                        </div>
                     </div>
            ...
            <div className="lg:col-span-7 p-12 md:p-16">
               <Reveal>
                  ...
                  <p className="text-clinical-muted text-sm mb-10">Lütfen aşağıdaki bilgileri eksiksiz doldurunuz.</p>
               </Reveal>
